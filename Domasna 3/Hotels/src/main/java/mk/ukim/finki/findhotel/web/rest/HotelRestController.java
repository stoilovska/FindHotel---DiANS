...
//    public ResponseEntity<?> getBookByBookName(@RequestParam(value = "hotelName") String hotelName){
//        Hotel hotel = hotelService.findHotelByName(hotelName);
//        return new ResponseEntity<>(hotel, HttpStatus.OK);
//    }
//
//    @GetMapping
//    public ResponseEntity<?> getBookByAuthorsName(@RequestParam(value = "street") String street) {
